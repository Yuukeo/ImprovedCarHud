...
local HUD = {
	...
	Cruise			= true,  	-- Enables/Disables The CRUISE Control status (default key F7)
	...
	--  ####         	 PLANE HUD	  	  	  ####  --
			...
			if PedHeli then
				...
				if HUDPlane.Panel then
					...
					if EngineRunning then
						drawTxt(UI.x + 0.620, UI.y + 1.240, 1.0,1.0,0.45, "ENGINE", 0, 255, 0,200)
					else
						drawTxt(UI.x + 0.620, UI.y + 1.240, 1.0,1.0,0.45, "ENGINE", 255, 0, 0, 200)
					end
				end
			end
	--  ####         	 PLANE HUD	  	  	  ####  --			
			...
			if HUD.Cruise and PedHeli == false and PedPlane == false and PedBoat == false then
				...
				if IsControlJustPressed(0, 168) and not (Speed == 0.0) then -- F7
					cruisecolor = true
			...
			if HUD.Top and PedHeli == false and PedPlane == false and PedBoat == false then
				...
				if (VehEngineHP > 0) and (VehEngineHP < EngineHpBroken) then
					...
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "ENGINE", 255, 0, 0, 200)
				elseif (VehEngineHP > 111) and (VehEngineHP < EngineHpAlmostBroken) then 
					...
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "ENGINE", 255, 255, 0,200)
				else
					...
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "ENGINE", 0, 255, 0,200)
				end
			...
			if HUD.Engine and PedHeli == false and PedPlane == false and PedBoat == false then
				if EngineRunning then
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "ENGINE", 0, 255, 0,200) -- ENGINE green
				else
					drawTxt(UI.x + 0.619, UI.y + 1.245, 1.0,1.0,0.45, "ENGINE", 255, 0, 0, 200) -- ENGINE red
					RPM = 0
				end
			end
